    ...
    public class VaultDashboard : EditorWindow
    {
        ...
        public static IDataGroup CurrentSelectedGroup
        {
            ...
            private set
            {
                ...
                VaultEditorSettings.SetString(VaultEditorSettings.VaultData.CurrentGroupName, typeName);
        ...
        public VaultListFilter.FilterType GetAssetFilterPropertyType()
        {
            ...
            if (pName == "*ERROR*") return VaultListFilter.FilterType.String;
        ...
        public void SetCurrentGroup(IDataGroup group)
        {
            ...
            bool selectionIsACustomGroup = group.GetType() == typeof(VaultCustomDataGroup);
