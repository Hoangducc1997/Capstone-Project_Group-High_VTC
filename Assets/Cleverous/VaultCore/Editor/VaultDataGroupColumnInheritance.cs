...
namespace Cleverous.VaultDashboard
{
    public class VaultFilterColumnInheritance : VaultDataGroupColumn
    {
        ...
        private readonly List<IVaultDataGroupButton> m_filteringMustShow = new List<IVaultDataGroupButton>();
        ...
        public override VaultDataGroupFoldableButton SelectButtonByFullTypeName(string fullTypeName)
        {
            VaultDataGroupFoldableButton button = ScrollElement.Q<VaultDataGroupFoldableButton>(fullTypeName);
        ...
        public override VaultDataGroupFoldableButton SelectButtonByDisplayTitle(string title)
        {
        ...
        public override VaultDataGroupFoldableButton SelectButtonDirectly(VaultDataGroupFoldableButton button)
        {
            if (button == null) return null;
